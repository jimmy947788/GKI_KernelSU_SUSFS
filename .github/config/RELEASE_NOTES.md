...
Kernel-based root for Android GKI devices. This release pins the **builtin** driver at commit `b20dee702` with manager tag **v4.2.0** (KPM + kernel-side SUSFS). android13-5.10 SUSFS is `f2878eb5` (v2.3.0).

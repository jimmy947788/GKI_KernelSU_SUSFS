...
**日期：** 2026-09-23
**實作：** 分支 `sukisu-v4.2.0` 已按方案 A 改 pin。driver `b20dee702`、版本 ref `v4.2.0`（versionCode `40899`）、`android13-5.10` SUSFS `f2878eb5`（v2.3.0）。`2d40afc3` 會呼叫 builtin 沒有的 `ksu_handle_post_execveat_sucompat`。其他 GKI 版本沒有預設 SUSFS pin。
